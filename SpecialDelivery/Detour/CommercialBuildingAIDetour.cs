...
{
    internal class CommercialBuildingAIDetour
    {
        ...
        public static void Deploy()
        {
            if (!deployed)
            {
                ...
                Debugger.Log("Special Delivery: CommercialBuildingAI Methods detoured!");
            }
        }
        ...
        public static void Revert()
        {
            if (deployed)
            {
                ...
                Debugger.Log("Special Delivery: CommercialBuildingAI Methods restored!");
            }
        }
        ...
        {
            return SpecialDeliveryManager.instance.MaxIncomingLoadSizeCommercial;
        } 
    }
}
